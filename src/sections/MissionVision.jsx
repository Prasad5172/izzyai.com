function MissionVisionSection() {
  return (
    <div className="mt-32 p-4">
      ...
      <div className="flex  w-full md:w-fit lg:w-fit mt-10 flex-col md:flex-col lg:flex-row items-center justify-between md:mx-32 bg-slate-300 dark:bg-[#222A32] p-4 rounded-2xl lg:p-10 ">
